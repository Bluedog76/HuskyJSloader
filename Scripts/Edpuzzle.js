...
function openPopup(assignment) {
  ...
  <p style="font-size: 12px">Special Edition by <a target="_blank" href="https://github.com/Bluedog76">Bluedog76</a>. Feel free to duble check if you don't trust the edited code. -Also abyding by GPL v3 :D</p>
